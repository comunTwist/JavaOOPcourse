...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("All students (default):");
		for (Student student : groupOne.getStudents()) {
			System.out.println(student);
		}
		System.out.println();

		Console.setStudent(sc, groupOne);
		System.out.println("All students (interactive):");
		for (Student student : groupOne.getStudents()) {
			System.out.println(student);
		}
		System.out.println();
		...
		System.out.println("All students (sort):");
		for (Student student : groupOne.getStudents()) {
			System.out.println(student);
		}
		System.out.println();

		File groupFile = new File("a.txt");
		groupOne.saveGroupToFile(groupFile, groupOne.toString());

		Group groupTwo = groupOne.createGroupFromFile(groupFile);
